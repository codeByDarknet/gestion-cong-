...
@section('title', 'Demandes des Employés')
...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        {{-- ici il y aura un systeme de filtres avec du javascript a travers le status de la demande  --}}
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Toutes les demandes ({{$demandes->count()}})</h6>
                    </div>
                                                                ...
                                                                <div class="modal-body p-4 py-0">
                                                                    ...
                                                                    @if ($demande->statut === 'Demandée')
                                                                        <div class="modal-footer justify-content-start">
                                                                            <form
                                                                                action="{{ route('responsable.demande.accepter', $demande->id) }}"
                                                                            ...
                                                                            <form
                                                                                action="{{ route('responsable.demande.rejeter', $demande->id) }}"
                                                                                method="POST" class="d-inline">
                                                                                @csrf
                                                                                <button type="submit"
    ...
    <script>
        // Fonction pour compter les demandes par statut et mettre à jour les boutons
        ...
        // Fonction pour filtrer les demandes et garder les couleurs originales
        // Fonction pour filtrer les demandes et appliquer le focus correctement
        function filterTable(status, button) {
            ...
            document.querySelectorAll(".btn-filter").forEach(btn => {
                ...
                btn.style.borderWidth = "2px"; // Garder une bordure fixe pour éviter tout changement de taille
                btn.style.borderColor = "transparent"; // Invisible par défaut
