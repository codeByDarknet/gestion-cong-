...
@section('title', 'Demandes personnelles')
                                        ...
                                        <div class="modal-dialog modal-md modal-dialog-centered">
                                            <div class="modal-content border-0 shadow-sm rounded">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    {{-- les commentaires de mes modifications si je l'ai faite --}}
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Annuler</button>
                                            <form id="submitForm"
                                                action="{{ route('responsable.demande.soumettre', $demande->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                ...
                                <div class="modal fade" id="demandeModification{{ $demande->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 shadow-lg rounded-3">
                                            <form
                                                action="{{ route('responsable.demande.demander.modification', $demande->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
    ...
    <div class="modal fade" id="plannifierDemandeModal" tabindex="-1" aria-labelledby="plannifierDemandeLabel"
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('responsable.demande.planifier') }}" method="POST">
                        @csrf
