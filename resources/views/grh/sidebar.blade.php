    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
                ...
                <div class="navbar-brand flex items-center space-x-3 p-2">
                    <!-- Logo SVG -->
                    <span class="text-primary text-2xl font-bold uppercase">Opti</span>
                    <span class="text-lg font-semibold text-gray-700">Congé</span>

                    <!-- Logo Image (optional) -->
                    <img src="{{ asset('img/logo_ibam.png') }}" alt="logo" class="navbar-brand-img h-auto max-h-14" style="max-height: 55px;">
                </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Str::contains(request()->path(), 'dashboard') ? 'active' : '' }} "  href="{{ route('grh.dashboard') }}">
                ...
                {{-- les demandes   --}}
                <li class="nav-item">
                    <a class="nav-link   {{ Str::contains(request()->path(), 'demandes') ? 'active' : '' }} " href="/toutes-les-demandes">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Les demandes</span>
                    </a>
                </li>
                {{-- les employés --}}
                <li class="nav-item">
                    <a class="nav-link  {{ Str::contains(request()->path(), 'employes') ? 'active' : '' }}" href="/liste-des-employes">

                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            @if (Str::contains(request()->path(), 'employes'))
                                <i class="fa-solid fa-clipboard-user fa-3x text-lg  text-white"></i>
                            @else
                                <i class="fa-solid fa-clipboard-user fa-3x text-lg  text-black"></i>
                            @endif
                        </div>
                        ...
                        <span class="nav-link-text ms-1">Les Employés</span>
                    </a>
                </li>

                {{-- les types de conges/ absences --}}

                <li class="nav-item">
                    <a class="nav-link  {{ Str::contains(request()->path(), 'types-de-conges') ? 'active' : '' }}" href="/types-de-conges-absences">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Types de conges/absences</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ Str::contains(request()->path(), 'services') ? 'active' : '' }}" href="/liste-des-services">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
